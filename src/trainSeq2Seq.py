...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        plt.plot(epochError)
        plt.savefig('figplot_seq2seq/'+'1'+'-'+'1'+'.png')    
        torch.save(encoder.state_dict(), 'checkpoint_seq2seq/'+'encoder'+str(epoch)+'.pt')
        torch.save(decoder.state_dict(), 'checkpoint_seq2seq/'+'decoder'+str(epoch)+'.pt')